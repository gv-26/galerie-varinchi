export default function PrivacyPage() {
  return (
    <div className="static-page fade-in">
      <h1 className="heading-serif">Privacy Policy</h1>
      ...
      <p>
        ...
        purchases, send you promotional communications (with your consent), and improve our services.
      ...
      <p>
        ...
        our website, conducting our business, or servicing you. These parties are obligated to keep
        your information confidential and are only permitted to use it for the purposes we specify.
      </p>
